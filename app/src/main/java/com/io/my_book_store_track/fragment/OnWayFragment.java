...
public class OnWayFragment extends Fragment implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_updateStatus:
                if (a.equals("")) {
                    Toast.makeText(activity, "please scan bar code ", Toast.LENGTH_SHORT).show();
                } else {
    ...
    private void apiOrderStatusUpdate() {
        if (user.isOnline(activity)) {
            ...
            dialog.show();
            if (Config.devliveryStatus.equals(outdev)||Config.devliveryStatus.equals("Delivered") ) {
                dialog.dismiss();
                Toast.makeText(activity, "you have already update status : " + Config.devliveryStatus, Toast.LENGTH_SHORT).show();
            } else {

                ApiCaller.updateOrder(activity, Config.Url.updateStatus, Config.OrderID, Config.driverID, file, outdev, new FutureCallback<OrderUpdateResponseModel>() {
